...
\(h:\mathbb{R}^2\rightarrow\mathbb{R}\). Show that \(S\) defined by any
kernel \(h\) is a Linear Shift Invariant (LSI) system. In other words,
for any \(h\), show that \(S\) satisfies both of the following: -
\(S[a\cdot{f_1}+b\cdot{f_2}]= a\cdot{S[f_1]}+b\cdot{S[f_2]}\) - If
\(f[m,n]\xrightarrow{s}g[m,n]\) then
\(f[m-m_0,n-n_0]\xrightarrow{s}g[m-m_0,n-n_0]\)
...
\tightlist
\item
  \(S[a\cdot{f_1}+b\cdot{f_2}] = h\cdot{(a\cdot{f_1} + b\cdot{f_2})} = a\cdot{h\cdot{f_1}} + b\cdot{h\cdot{f_2}} = a\cdot{S[f_1]}+b\cdot{S[f_2]}\)
\item
  \(f[m,n]\xrightarrow{s}g[m,n] = \sum_{i=-\infty}^\infty\sum_{j=-\infty}^\infty h[i,j]\cdot f[m-i,n-j] \\ f[m-m_0,n-n_0]\xrightarrow{s}\sum_{i=-\infty}^\infty\sum_{j=-\infty}^\infty h[i,j]\cdot f[(m-m_0)-i,(n-n_0)-j] = g[m-m_0,n-n_0]\)
\end{itemize}

    \subsubsection{1.3 Implementation (30
...
{\color{incolor}In [{\color{incolor}3}]:} \PY{k+kn}{from} \PY{n+nn}{filters} \PY{k}{import} \PY{n}{conv\PYZus{}nested}
        ...
        \PY{n}{expected\PYZus{}output}\PY{p}{[}\PY{l+m+mi}{4}\PY{p}{,} \PY{l+m+mi}{2}\PY{p}{:}\PY{l+m+mi}{7}\PY{p}{]} \PY{o}{=} \PY{l+m+mi}{2}
        \PY{n}{expected\PYZus{}output}\PY{p}{[}\PY{l+m+mi}{2}\PY{p}{:}\PY{l+m+mi}{7}\PY{p}{,} \PY{l+m+mi}{4}\PY{p}{]} \PY{o}{=} \PY{l+m+mi}{2}
        \PY{n}{expected\PYZus{}output}\PY{p}{[}\PY{l+m+mi}{4}\PY{p}{,} \PY{l+m+mi}{4}\PY{p}{]} \PY{o}{=} \PY{l+m+mi}{4}
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{hw1_files/hw1_10_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
{\color{incolor}In [{\color{incolor}4}]:} \PY{k+kn}{from} \PY{n+nn}{filters} \PY{k}{import} \PY{n}{conv\PYZus{}nested}
        ...
        \PY{n}{solution\PYZus{}img} \PY{o}{=} \PY{n}{io}\PY{o}{.}\PY{n}{imread}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{convoluted\PYZus{}dog.jpg}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{as\PYZus{}grey}\PY{o}{=}\PY{k+kc}{True}\PY{p}{)}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
conv\_nested: took 0.962481 seconds.
conv\_fast: took 0.477488 seconds.

    \end{Verbatim}

    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{hw1_files/hw1_16_1.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \subsubsection{Extra Credit 1 (1\% of final
grade)}\label{extra-credit-1-1-of-final-grade}

Devise a faster version of convolution and implement
\textbf{\texttt{conv\_faster}} in \textbf{\texttt{filters.py}}. You will
earn extra credit only if the \texttt{conv\_faster} runs faster (by a
fair margin) than \texttt{conv\_fast} \textbf{and} outputs the same
result.

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}7}]:} \PY{k+kn}{from} \PY{n+nn}{filters} \PY{k}{import} \PY{n}{conv\PYZus{}faster}
        
        \PY{n}{t0} \PY{o}{=} \PY{n}{time}\PY{p}{(}\PY{p}{)}
        \PY{n}{out\PYZus{}fast} \PY{o}{=} \PY{n}{conv\PYZus{}fast}\PY{p}{(}\PY{n}{img}\PY{p}{,} \PY{n}{kernel}\PY{p}{)}
        \PY{n}{t1} \PY{o}{=} \PY{n}{time}\PY{p}{(}\PY{p}{)}
        \PY{n}{out\PYZus{}faster} \PY{o}{=} \PY{n}{conv\PYZus{}faster}\PY{p}{(}\PY{n}{img}\PY{p}{,} \PY{n}{kernel}\PY{p}{)}
        \PY{n}{t2} \PY{o}{=} \PY{n}{time}\PY{p}{(}\PY{p}{)}
        
        \PY{c+c1}{\PYZsh{} Compare the running time of the two implementations}
        \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{conv\PYZus{}fast: took }\PY{l+s+si}{\PYZpc{}f}\PY{l+s+s2}{ seconds.}\PY{l+s+s2}{\PYZdq{}} \PY{o}{\PYZpc{}} \PY{p}{(}\PY{n}{t1} \PY{o}{\PYZhy{}} \PY{n}{t0}\PY{p}{)}\PY{p}{)}
        \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{conv\PYZus{}faster: took }\PY{l+s+si}{\PYZpc{}f}\PY{l+s+s2}{ seconds.}\PY{l+s+s2}{\PYZdq{}} \PY{o}{\PYZpc{}} \PY{p}{(}\PY{n}{t2} \PY{o}{\PYZhy{}} \PY{n}{t1}\PY{p}{)}\PY{p}{)}
        ...
        \PY{c+c1}{\PYZsh{} Plot conv\PYZus{}fast output}
        \PY{n}{plt}\PY{o}{.}\PY{n}{subplot}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{,}\PY{l+m+mi}{2}\PY{p}{,}\PY{l+m+mi}{2}\PY{p}{)}
        \PY{n}{plt}\PY{o}{.}\PY{n}{imshow}\PY{p}{(}\PY{n}{out\PYZus{}faster}\PY{p}{)}
        \PY{n}{plt}\PY{o}{.}\PY{n}{title}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{conv\PYZus{}faster}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
        \PY{n}{plt}\PY{o}{.}\PY{n}{axis}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{off}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
        
        \PY{c+c1}{\PYZsh{} Make sure that the two outputs are the same}
        \PY{k}{if} \PY{o+ow}{not} \PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{max}\PY{p}{(}\PY{n}{out\PYZus{}fast} \PY{o}{\PYZhy{}} \PY{n}{out\PYZus{}faster}\PY{p}{)} \PY{o}{\PYZlt{}} \PY{l+m+mf}{1e\PYZhy{}10}\PY{p}{)}\PY{p}{:}
            \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Different outputs! Check your implementation.}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
\end{Verbatim}
...
Different outputs! Check your implementation.
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{hw1_files/hw1_18_1.png}
    \end{center}
    { \hspace*{\fill} \\}
...
implemented in the previous question.}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}8}]:} \PY{k+kn}{from} \PY{n+nn}{filters} \PY{k}{import} \PY{n}{cross\PYZus{}correlation}
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{hw1_files/hw1_21_0.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \paragraph{Interpretation}\label{interpretation}

How does the output of cross-correlation filter look like? Was it able
to detect the product correctly? Explain what might be the problem with
using raw template as a filter.

    \textbf{Your Answer:}

High intensity values are scattered all over the output. It wasn't able
to detect the product correctly, because the idea is to match negative
values and positive values and finally to get high overall summation.
For our case, just because filter and image simmilar areas don't contain
matching negative values, the overall summation doesn't result
exceptional high values.
...
A solution to this problem is to subtract off the mean value of the
template so that it has zero mean.

Implement \textbf{\texttt{zero\_mean\_cross\_correlation}} function in
\textbf{\texttt{filters.py}} and run the code below.

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}9}]:} \PY{k+kn}{from} \PY{n+nn}{filters} \PY{k}{import} \PY{n}{zero\PYZus{}mean\PYZus{}cross\PYZus{}correlation}
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{hw1_files/hw1_25_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
scaling and thresholding.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}10}]:} \PY{k}{def} \PY{n+nf}{check\PYZus{}product\PYZus{}on\PYZus{}shelf}\PY{p}{(}\PY{n}{shelf}\PY{p}{,} \PY{n}{product}\PY{p}{)}\PY{p}{:}
         ...
         \PY{n}{img2\PYZus{}grey} \PY{o}{=} \PY{n}{io}\PY{o}{.}\PY{n}{imread}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{shelf\PYZus{}soldout.jpg}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{as\PYZus{}grey}\PY{o}{=}\PY{k+kc}{True}\PY{p}{)}
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{hw1_files/hw1_27_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
The product is on the shelf
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{hw1_files/hw1_27_2.png}
    \end{center}
    { \hspace*{\fill} \\}
...
{\color{incolor}In [{\color{incolor}11}]:} \PY{k+kn}{from} \PY{n+nn}{filters} \PY{k}{import} \PY{n}{normalized\PYZus{}cross\PYZus{}correlation}
         ...
         \PY{n}{img\PYZus{}grey} \PY{o}{=} \PY{n}{io}\PY{o}{.}\PY{n}{imread}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{shelf\PYZus{}dark.jpg}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{as\PYZus{}grey}\PY{o}{=}\PY{k+kc}{True}\PY{p}{)}
...
\textbf{\texttt{filters.py}} and run the code below.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}12}]:} \PY{k+kn}{from} \PY{n+nn}{filters} \PY{k}{import} \PY{n}{normalized\PYZus{}cross\PYZus{}correlation}
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{hw1_files/hw1_31_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
Run the code below to see its effect.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}13}]:} \PY{c+c1}{\PYZsh{} Load image}
         \PY{n}{img} \PY{o}{=} \PY{n}{io}\PY{o}{.}\PY{n}{imread}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{dog.jpg}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{as\PYZus{}grey}\PY{o}{=}\PY{k+kc}{True}\PY{p}{)}
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{hw1_files/hw1_38_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\texttt{k2}) whose product is equal to the Gaussian kernel.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}14}]:} \PY{c+c1}{\PYZsh{} The kernel can be written as outer product of two 1D filters}
         \PY{n}{k1} \PY{o}{=} \PY{n}{kernel}\PY{p}{[}\PY{p}{:}\PY{p}{,} \PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{]}  \PY{c+c1}{\PYZsh{} shape (5, 1)}
         \PY{n}{k2} \PY{o}{=} \PY{n}{kernel}\PY{p}{[}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{]}  \PY{c+c1}{\PYZsh{} shape (1, 5)}
...
convolutions must be the same.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}15}]:} \PY{c+c1}{\PYZsh{} Perform two convolutions using k1 and k2}
         \PY{n}{t0} \PY{o}{=} \PY{n}{time}\PY{p}{(}\PY{p}{)}
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{hw1_files/hw1_42_0.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{Verbatim}[commandchars=\\\{\}]
Normal convolution: took 2.451458 seconds.
Separable convolution: took 1.304245 seconds.

    \end{Verbatim}

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}16}]:} \PY{c+c1}{\PYZsh{} Check if the two outputs are equal}
         \PY{k}{assert} \PY{n}{np}\PY{o}{.}\PY{n}{max}\PY{p}{(}\PY{n}{out\PYZus{}separable} \PY{o}{\PYZhy{}} \PY{n}{out}\PY{p}{)} \PY{o}{\PYZlt{}} \PY{l+m+mf}{1e\PYZhy{}10}
\end{Verbatim}
